...
[Imagens de aplicação e de sistema operacional](imagens/image-(1).png)
...
[Tipo de Instância](imagens/image-(2).png)
...
[Par de chaves](imagens/image-(3).png)
...
[Configurações de rede](imagens/image-(4).png)
...
[Configurar armazenamento](imagens/image-(5).png)
...
[Executar a instância](imagens/image-(6).png)
[Instância criada](imagens/image-(7).png)
...
[IP da instância](imagens/image-(8).png)
...
2. **Acessar a instância via SSH:** Foi aberto o terminal do WSL e foi executado o seguinte comando para acessar a instância via SSH:
    ...
    [Acesso à instância via SSH](imagens/image-(10).png)
